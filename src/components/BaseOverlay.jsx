...
export function BaseOverlay({ isOpen, onClose, children }) {
  ...
  return (
    <>
      {isOpen && (
        <div className="fixed inset-0 z-0 flex items-start space-x-4 justify-center p-4 pt-20 transition-opacity duration-300 ease-out">
          {/* Overlay Background */}
          <div
          ...
          {/* Overlay Container */}
          <div className="overlay-container relative bg-gray-100 dark:bg-gray-800 rounded-lg shadow-lg max-h-[85vh] sm:max-h-[90vh] w-full max-w-4xl overflow-y-auto p-6 transform transition-transform duration-300 scale-95 opacity-0 fade-in-out-animation">
            {/* Overlay Content */}
