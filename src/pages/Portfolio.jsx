    ...
    <div className="min-h-auto flex flex-col justify-center p-6 pt-4 mt-12">
      <div className="w-full max-w-4xl mx-auto">
        ...
        <div className="space-y-6">
          ...
          >
            <img src="../src/assets/stocks/StockDetails.png" alt="Simulated Stock Market" className="sm:w-1/3 h-auto max-w-full object-center border-2 border-superLightColor rounded-sm sm:mr-4 mb-4 sm:mb-0 flex-shrink-0 shadow-lg" />
            <div className="flex flex-col justify-center text-left">
              <h3 className="text-md font-bold mb-2 dark:text-superLightColor group-hover:text-darkColor dark:group-hover:text-white transition-colors drop-shadow-lg">Simulated Stock Market</h3>
              <p className="text-xs dark:text-superLightColor group-hover:text-darkColor dark:group-hover:text-white transition-colors">This platform allows users to buy and sell fictional stocks in real-time, using virtual currency. Track your portfolio and see how the market evolves!</p>
