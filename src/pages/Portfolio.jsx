    ...
    <div className="min-h-screen flex flex-col justify-center p-6">
      <div className="w-full max-w-4xl mx-auto">
        ...
        <div className="space-y-6">
          ...
          >
            <img
              src="path_to_web_project1_image.jpg"
              alt="Web Project 1"
              className="w-full sm:w-1/3 h-40 object-cover rounded-lg sm:mr-4 mb-4 sm:mb-0"
            />
          ...
          >
            <img
              src="path_to_web_project2_image.jpg"
              alt="Web Project 2"
              className="w-full sm:w-1/3 h-40 object-cover rounded-lg sm:mr-4 mb-4 sm:mb-0"
            />
            <div className="flex flex-col justify-center text-left">
        ...
        <div className="space-y-6">
          ...
          >
            <img
              src="path_to_game_project1_image.jpg"
              alt="Game Project 1"
              className="w-full sm:w-1/3 h-40 object-cover rounded-lg sm:mr-4 mb-4 sm:mb-0"
            />
            <div className="flex flex-col justify-center text-left">
          ...
          >
            <img
              src="path_to_game_project2_image.jpg"
              alt="Game Project 2"
              className="w-full sm:w-1/3 h-40 object-cover rounded-lg sm:mr-4 mb-4 sm:mb-0"
            />
            <div className="flex flex-col justify-center text-left">
      ...
      {/* Overlay */}
      <WebProject1Overlay isOpen={isOpen} onClose={closeOverlay} />
    </div>
  );
};
